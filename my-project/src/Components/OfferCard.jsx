...
export default function OfferCard({ offer }) {
  return (
    <div className="offer-card bg-white border p-4 rounded-lg shadow-md  max-w-[52rem]  flex">
      {/* Offer Image */}
      <div className="offer-image w-1/4">
        <img src={offer.image} alt="Trip" className="w-full h-auto rounded-lg" />
      </div>

      {/* Offer Details */}
      <div className="offer-details pl-4 flex flex-col justify-between w-3/4">
        ...
        {/* Title */}
        <h3 className="offer-title text-lg font-bold mt-2">{offer.title}</h3>

        {/* Departure Date */}
        <p className="departure-date text-sm text-gray-600 mt-1">{offer.departureDate}</p>
        ...
        <div className="buttons flex">
          ...
          {/* View Details Button */}
          <button className="view-details flex-1 bg-[#4EB7AC] text-white p-2 rounded-lg">
            View Details
          </button>
        </div>
      </div>
