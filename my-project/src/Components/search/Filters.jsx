export default function Filters({ filters, setFilters }) {
  ...
  return (
    <div className="text-left bg-white p-6 max-w-md mx-auto rounded-lg border border-gray-300">
      {/* Filters Title */}
      ...
      <div className="mb-8"> {/* Increased height */}
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="text-sm">1 Million</div>
          <div className="text-sm">20 Million</div>
        </div>
        ...
        <div className="flex space-x-6 mb-2">
          {["1", "2", "3", "4", "5"].map((rating) => (
            <button
              ...
              className={`px-1 py-1 rounded-lg border-2 ${filters.rating === rating
